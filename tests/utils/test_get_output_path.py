...
def test_get_output_path_success():
    ...
    with patch("legend_data_monitor.utils.get_query_timerange", return_value={"timestamp": {"start": "20220928T080000Z", "end": "20220928T093000Z"}}), \
         patch("legend_data_monitor.utils.make_output_paths", return_value="/tmp/output/"), \
         patch("legend_data_monitor.utils.get_run_name", return_value="20220928T080000Z_20220928T093000Z"), \
         patch("legend_data_monitor.utils.get_time_name", return_value="20220928T080000Z_20220928T093000Z"), \
