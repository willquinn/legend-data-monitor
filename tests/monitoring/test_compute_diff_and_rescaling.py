...
def test_compute_diffs_variations():
    ...
    # variations=True
    diff, diff_scaled = compute_diff_and_rescaling(s, reference, escale, variations=True)
...
def test_compute_diffs_no_variations():
    ...
    # variations=False
    diff, diff_scaled = compute_diff_and_rescaling(s, reference, escale, variations=False)
