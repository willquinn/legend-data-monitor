...
cmd = "apptainer run"  # run command for loading the container
...
# paths
auto_dir_path = (
    "/data2/public/prodenv/prod-blind/tmp/auto"  # where to retrieve lh5 dsp/hit files
)
source_dir = f"{auto_dir_path}/generated/tier/dsp/phy/{period}/{run}/"  # same as auto_dir_path, but we look for a specific run of a given period
