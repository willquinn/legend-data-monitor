...
class Subsystem():
    ...
    def __init__(self, config, sub_type):
        ...
        self.parameters = config.subsystems[sub_type]['parameters'] if sub_type in config.subsystems else []
    ...
    def flag_pulser_events(self, pulser):
        ...
        pulser_timestamps = pulser.data[ pulser.data['wf_max_rel'] > high_thr ]['datetime']
        # flag data
