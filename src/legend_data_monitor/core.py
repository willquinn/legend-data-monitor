    ...
    for system in subsystems_to_plot:
        ...
        if system not in subsystems:
            ...
            for plot in config["subsystems"][system].keys():
                ...
                if (
                    "AUX_ratio" in config["subsystems"][system][plot].keys()
                    and "AUX_diff" in config["subsystems"][system][plot].keys()
                ):
                    utils.logger.warning(
                ...
                if (
                    "AUX_ratio" in config["subsystems"][system][plot].keys()
                    or "AUX_diff" in config["subsystems"][system][plot].keys()
                ):
                    ...
                    subsystems[system].include_aux(
                        params, config["dataset"], config["subsystems"][system][plot]
                    )
